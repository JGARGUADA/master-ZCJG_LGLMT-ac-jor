CLASS zcl_clientes_libros_load_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*
*
CLASS zcl_clientes_libros_load_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
**Añadimos el código del script para poder insertar datos en tablas de base de datos

    DATA: lt_acc_categ TYPE TABLE OF ztb_acc_categ194,
          lt_catego    TYPE TABLE OF ztb_catego_9194,
          lt_clientes  TYPE TABLE OF ztb_cliente_9194,
          lt_clnts_lib TYPE TABLE OF ztb_clntslib9194,
          lt_libros    TYPE TABLE OF ztb_libros_9194.
...
********* ZTB_ACC_CATEG194 ********
    ...
    DELETE FROM ztb_acc_categ194.
    INSERT ztb_acc_categ194 FROM TABLE @lt_acc_categ.
...
********* ZTB_CATEGGO_9194 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_catego_9194.
    INSERT ztb_catego_9194 FROM TABLE @lt_catego.
...
********* ZTB_CLIENTE_9194 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_cliente_9194.
    INSERT ztb_cliente_9194 FROM TABLE @lt_clientes.
...
********* ZTB_CLNTSLIB194
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_clntslib9194.
    INSERT ztb_clntslib9194 FROM TABLE @lt_clnts_lib.
...
********* ZTB_LIBROS_9194 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    DELETE FROM ztb_libros_9194.
    INSERT ztb_libros_9194 FROM TABLE @lt_libros.
